...
state_data[230] <- (state_data[230]) * (KG_AGG$x[KG_AGG$Column.A == 240])
state_data[241] <- (state_data[241]) * (KG_AGG$x[KG_AGG$Column.A == 241])
state_data[242] <- (state_data[242]) * (KG_AGG$x[KG_AGG$Column.A == 242])
state_data[243] <- (state_data[243]) * (KG_AGG$x[KG_AGG$Column.A == 243])
state_data[244] <- (state_data[244]) * (KG_AGG$x[KG_AGG$Column.A == 244])
state_data[245] <- (state_data[245]) * (KG_AGG$x[KG_AGG$Column.A == 245])
state_data[246] <- (state_data[246]) * (KG_AGG$x[KG_AGG$Column.A == 246])
state_data[247] <- (state_data[247]) * (KG_AGG$x[KG_AGG$Column.A == 247])
state_data[248] <- (state_data[248]) * (KG_AGG$x[KG_AGG$Column.A == 248])
state_data[249] <- (state_data[249]) * (KG_AGG$x[KG_AGG$Column.A == 249])
state_data[250] <- (state_data[250]) * (KG_AGG$x[KG_AGG$Column.A == 250])
state_data[251] <- (state_data[251]) * (KG_AGG$x[KG_AGG$Column.A == 251])
state_data[252] <- (state_data[252]) * (KG_AGG$x[KG_AGG$Column.A == 252])
state_data[253] <- (state_data[253]) * (KG_AGG$x[KG_AGG$Column.A == 253])
state_data[254] <- (state_data[254]) * (KG_AGG$x[KG_AGG$Column.A == 254])
state_data[255] <- (state_data[255]) * (KG_AGG$x[KG_AGG$Column.A == 255])
state_data[256] <- (state_data[256]) * (KG_AGG$x[KG_AGG$Column.A == 256])
state_data[257] <- (state_data[257]) * (KG_AGG$x[KG_AGG$Column.A == 257])
state_data[258] <- (state_data[258]) * (KG_AGG$x[KG_AGG$Column.A == 258])
state_data[259] <- (state_data[259]) * (KG_AGG$x[KG_AGG$Column.A == 259])
state_data[260] <- (state_data[260]) * (KG_AGG$x[KG_AGG$Column.A == 260])
state_data[261] <- (state_data[261]) * (KG_AGG$x[KG_AGG$Column.A == 261])
state_data[262] <- (state_data[262]) * (KG_AGG$x[KG_AGG$Column.A == 262])
state_data[263] <- (state_data[263]) * (KG_AGG$x[KG_AGG$Column.A == 263])
state_data[264] <- (state_data[264]) * (KG_AGG$x[KG_AGG$Column.A == 264])
state_data[265] <- (state_data[265]) * (KG_AGG$x[KG_AGG$Column.A == 265])
state_data[266] <- (state_data[266]) * (KG_AGG$x[KG_AGG$Column.A == 266])
state_data[267] <- (state_data[267]) * (KG_AGG$x[KG_AGG$Column.A == 267])
state_data[268] <- (state_data[268]) * (KG_AGG$x[KG_AGG$Column.A == 268])
state_data[269] <- (state_data[269]) * (KG_AGG$x[KG_AGG$Column.A == 269])
state_data[270] <- (state_data[270]) * (KG_AGG$x[KG_AGG$Column.A == 270])
state_data[271] <- (state_data[271]) * (KG_AGG$x[KG_AGG$Column.A == 271])
state_data[272] <- (state_data[272]) * (KG_AGG$x[KG_AGG$Column.A == 272])
state_data[273] <- (state_data[273]) * (KG_AGG$x[KG_AGG$Column.A == 273])
state_data[274] <- (state_data[274]) * (KG_AGG$x[KG_AGG$Column.A == 274])
state_data[275] <- (state_data[275]) * (KG_AGG$x[KG_AGG$Column.A == 275])
state_data[276] <- (state_data[276]) * (KG_AGG$x[KG_AGG$Column.A == 276])
state_data[277] <- (state_data[277]) * (KG_AGG$x[KG_AGG$Column.A == 277])
state_data[278] <- (state_data[278]) * (KG_AGG$x[KG_AGG$Column.A == 278])
state_data[279] <- (state_data[279]) * (KG_AGG$x[KG_AGG$Column.A == 279])


state_data[1] <- (state_data[1]) * (KG_CONF$x[KG_CONF$Column.A == 1])
state_data[2] <- (state_data[2]) * (KG_CONF$x[KG_CONF$Column.A == 2])
state_data[3] <- (state_data[3]) * (KG_CONF$x[KG_CONF$Column.A == 3])
state_data[4] <- (state_data[4]) * (KG_CONF$x[KG_CONF$Column.A == 4])
state_data[5] <- (state_data[5]) * (KG_CONF$x[KG_CONF$Column.A == 5])
state_data[6] <- (state_data[6]) * (KG_CONF$x[KG_CONF$Column.A == 6])
state_data[7] <- (state_data[7]) * (KG_CONF$x[KG_CONF$Column.A == 7])
state_data[8] <- (state_data[8]) * (KG_CONF$x[KG_CONF$Column.A == 8])
state_data[9] <- (state_data[9]) * (KG_CONF$x[KG_CONF$Column.A == 9])
state_data[10] <- (state_data[10]) * (KG_CONF$x[KG_CONF$Column.A == 10])
state_data[11] <- (state_data[11]) * (KG_CONF$x[KG_CONF$Column.A == 11])
state_data[12] <- (state_data[12]) * (KG_CONF$x[KG_CONF$Column.A == 12])
state_data[13] <- (state_data[13]) * (KG_CONF$x[KG_CONF$Column.A == 13])
state_data[14] <- (state_data[14]) * (KG_CONF$x[KG_CONF$Column.A == 14])
state_data[15] <- (state_data[15]) * (KG_CONF$x[KG_CONF$Column.A == 15])
state_data[16] <- (state_data[16]) * (KG_CONF$x[KG_CONF$Column.A == 16])
state_data[17] <- (state_data[17]) * (KG_CONF$x[KG_CONF$Column.A == 17])
state_data[18] <- (state_data[18]) * (KG_CONF$x[KG_CONF$Column.A == 18])
state_data[19] <- (state_data[19]) * (KG_CONF$x[KG_CONF$Column.A == 19])
state_data[20] <- (state_data[20]) * (KG_CONF$x[KG_CONF$Column.A == 20])
state_data[21] <- (state_data[21]) * (KG_CONF$x[KG_CONF$Column.A == 21])
state_data[22] <- (state_data[22]) * (KG_CONF$x[KG_CONF$Column.A == 22])
state_data[23] <- (state_data[23]) * (KG_CONF$x[KG_CONF$Column.A == 23])
state_data[24] <- (state_data[24]) * (KG_CONF$x[KG_CONF$Column.A == 24])
state_data[25] <- (state_data[25]) * (KG_CONF$x[KG_CONF$Column.A == 25])
state_data[26] <- (state_data[26]) * (KG_CONF$x[KG_CONF$Column.A == 26])
state_data[27] <- (state_data[27]) * (KG_CONF$x[KG_CONF$Column.A == 27])
state_data[28] <- (state_data[28]) * (KG_CONF$x[KG_CONF$Column.A == 28])
state_data[29] <- (state_data[29]) * (KG_CONF$x[KG_CONF$Column.A == 29])
state_data[30] <- (state_data[30]) * (KG_CONF$x[KG_CONF$Column.A == 30])
state_data[31] <- (state_data[31]) * (KG_CONF$x[KG_CONF$Column.A == 31])
state_data[32] <- (state_data[32]) * (KG_CONF$x[KG_CONF$Column.A == 32])
state_data[33] <- (state_data[33]) * (KG_CONF$x[KG_CONF$Column.A == 33])
state_data[34] <- (state_data[34]) * (KG_CONF$x[KG_CONF$Column.A == 34])
state_data[35] <- (state_data[35]) * (KG_CONF$x[KG_CONF$Column.A == 35])
state_data[36] <- (state_data[36]) * (KG_CONF$x[KG_CONF$Column.A == 36])
state_data[37] <- (state_data[37]) * (KG_CONF$x[KG_CONF$Column.A == 37])
state_data[38] <- (state_data[38]) * (KG_CONF$x[KG_CONF$Column.A == 38])
state_data[39] <- (state_data[39]) * (KG_CONF$x[KG_CONF$Column.A == 39])
state_data[30] <- (state_data[30]) * (KG_CONF$x[KG_CONF$Column.A == 40])
state_data[41] <- (state_data[41]) * (KG_CONF$x[KG_CONF$Column.A == 41])
state_data[42] <- (state_data[42]) * (KG_CONF$x[KG_CONF$Column.A == 42])
state_data[43] <- (state_data[43]) * (KG_CONF$x[KG_CONF$Column.A == 43])
state_data[44] <- (state_data[44]) * (KG_CONF$x[KG_CONF$Column.A == 44])
state_data[45] <- (state_data[45]) * (KG_CONF$x[KG_CONF$Column.A == 45])
state_data[46] <- (state_data[46]) * (KG_CONF$x[KG_CONF$Column.A == 46])
state_data[47] <- (state_data[47]) * (KG_CONF$x[KG_CONF$Column.A == 47])
state_data[48] <- (state_data[48]) * (KG_CONF$x[KG_CONF$Column.A == 48])
state_data[49] <- (state_data[49]) * (KG_CONF$x[KG_CONF$Column.A == 49])
state_data[50] <- (state_data[50]) * (KG_CONF$x[KG_CONF$Column.A == 50])
state_data[51] <- (state_data[51]) * (KG_CONF$x[KG_CONF$Column.A == 51])
state_data[52] <- (state_data[52]) * (KG_CONF$x[KG_CONF$Column.A == 52])
state_data[53] <- (state_data[53]) * (KG_CONF$x[KG_CONF$Column.A == 53])
state_data[54] <- (state_data[54]) * (KG_CONF$x[KG_CONF$Column.A == 54])
state_data[55] <- (state_data[55]) * (KG_CONF$x[KG_CONF$Column.A == 55])
state_data[56] <- (state_data[56]) * (KG_CONF$x[KG_CONF$Column.A == 56])
state_data[57] <- (state_data[57]) * (KG_CONF$x[KG_CONF$Column.A == 57])
state_data[58] <- (state_data[58]) * (KG_CONF$x[KG_CONF$Column.A == 58])
state_data[59] <- (state_data[59]) * (KG_CONF$x[KG_CONF$Column.A == 59])
state_data[60] <- (state_data[60]) * (KG_CONF$x[KG_CONF$Column.A == 60])
state_data[61] <- (state_data[61]) * (KG_CONF$x[KG_CONF$Column.A == 61])
state_data[62] <- (state_data[62]) * (KG_CONF$x[KG_CONF$Column.A == 62])
state_data[63] <- (state_data[63]) * (KG_CONF$x[KG_CONF$Column.A == 63])
state_data[64] <- (state_data[64]) * (KG_CONF$x[KG_CONF$Column.A == 64])
state_data[65] <- (state_data[65]) * (KG_CONF$x[KG_CONF$Column.A == 65])
state_data[66] <- (state_data[66]) * (KG_CONF$x[KG_CONF$Column.A == 66])
state_data[67] <- (state_data[67]) * (KG_CONF$x[KG_CONF$Column.A == 67])
state_data[68] <- (state_data[68]) * (KG_CONF$x[KG_CONF$Column.A == 68])
state_data[69] <- (state_data[69]) * (KG_CONF$x[KG_CONF$Column.A == 69])
state_data[70] <- (state_data[70]) * (KG_CONF$x[KG_CONF$Column.A == 70])
state_data[71] <- (state_data[71]) * (KG_CONF$x[KG_CONF$Column.A == 71])
state_data[72] <- (state_data[72]) * (KG_CONF$x[KG_CONF$Column.A == 72])
state_data[73] <- (state_data[73]) * (KG_CONF$x[KG_CONF$Column.A == 73])
state_data[74] <- (state_data[74]) * (KG_CONF$x[KG_CONF$Column.A == 74])
state_data[75] <- (state_data[75]) * (KG_CONF$x[KG_CONF$Column.A == 75])
state_data[76] <- (state_data[76]) * (KG_CONF$x[KG_CONF$Column.A == 76])
state_data[77] <- (state_data[77]) * (KG_CONF$x[KG_CONF$Column.A == 77])
state_data[78] <- (state_data[78]) * (KG_CONF$x[KG_CONF$Column.A == 78])
state_data[79] <- (state_data[79]) * (KG_CONF$x[KG_CONF$Column.A == 79])
state_data[80] <- (state_data[80]) * (KG_CONF$x[KG_CONF$Column.A == 80])
state_data[81] <- (state_data[81]) * (KG_CONF$x[KG_CONF$Column.A == 81])
state_data[82] <- (state_data[82]) * (KG_CONF$x[KG_CONF$Column.A == 82])
state_data[83] <- (state_data[83]) * (KG_CONF$x[KG_CONF$Column.A == 83])
state_data[84] <- (state_data[84]) * (KG_CONF$x[KG_CONF$Column.A == 84])
state_data[85] <- (state_data[85]) * (KG_CONF$x[KG_CONF$Column.A == 85])
state_data[86] <- (state_data[86]) * (KG_CONF$x[KG_CONF$Column.A == 86])
state_data[87] <- (state_data[87]) * (KG_CONF$x[KG_CONF$Column.A == 87])
state_data[88] <- (state_data[88]) * (KG_CONF$x[KG_CONF$Column.A == 88])
state_data[89] <- (state_data[89]) * (KG_CONF$x[KG_CONF$Column.A == 89])
state_data[90] <- (state_data[90]) * (KG_CONF$x[KG_CONF$Column.A == 90])
state_data[91] <- (state_data[91]) * (KG_CONF$x[KG_CONF$Column.A == 91])
state_data[92] <- (state_data[92]) * (KG_CONF$x[KG_CONF$Column.A == 92])
state_data[93] <- (state_data[93]) * (KG_CONF$x[KG_CONF$Column.A == 93])
state_data[94] <- (state_data[94]) * (KG_CONF$x[KG_CONF$Column.A == 94])
state_data[95] <- (state_data[95]) * (KG_CONF$x[KG_CONF$Column.A == 95])
state_data[96] <- (state_data[96]) * (KG_CONF$x[KG_CONF$Column.A == 96])
state_data[97] <- (state_data[97]) * (KG_CONF$x[KG_CONF$Column.A == 97])
state_data[98] <- (state_data[98]) * (KG_CONF$x[KG_CONF$Column.A == 98])
state_data[99] <- (state_data[99]) * (KG_CONF$x[KG_CONF$Column.A == 99])
state_data[100] <- (state_data[100]) * (KG_CONF$x[KG_CONF$Column.A == 100])
state_data[101] <- (state_data[101]) * (KG_CONF$x[KG_CONF$Column.A == 101])
state_data[102] <- (state_data[102]) * (KG_CONF$x[KG_CONF$Column.A == 102])
state_data[103] <- (state_data[103]) * (KG_CONF$x[KG_CONF$Column.A == 103])
state_data[104] <- (state_data[104]) * (KG_CONF$x[KG_CONF$Column.A == 104])
state_data[105] <- (state_data[105]) * (KG_CONF$x[KG_CONF$Column.A == 105])
state_data[106] <- (state_data[106]) * (KG_CONF$x[KG_CONF$Column.A == 106])
state_data[107] <- (state_data[107]) * (KG_CONF$x[KG_CONF$Column.A == 107])
state_data[108] <- (state_data[108]) * (KG_CONF$x[KG_CONF$Column.A == 108])
state_data[109] <- (state_data[109]) * (KG_CONF$x[KG_CONF$Column.A == 109])
state_data[110] <- (state_data[110]) * (KG_CONF$x[KG_CONF$Column.A == 110])
state_data[111] <- (state_data[111]) * (KG_CONF$x[KG_CONF$Column.A == 111])
state_data[112] <- (state_data[112]) * (KG_CONF$x[KG_CONF$Column.A == 112])
state_data[113] <- (state_data[113]) * (KG_CONF$x[KG_CONF$Column.A == 113])
state_data[114] <- (state_data[114]) * (KG_CONF$x[KG_CONF$Column.A == 114])
state_data[115] <- (state_data[115]) * (KG_CONF$x[KG_CONF$Column.A == 115])
state_data[116] <- (state_data[116]) * (KG_CONF$x[KG_CONF$Column.A == 116])
state_data[117] <- (state_data[117]) * (KG_CONF$x[KG_CONF$Column.A == 117])
state_data[118] <- (state_data[118]) * (KG_CONF$x[KG_CONF$Column.A == 118])
state_data[119] <- (state_data[119]) * (KG_CONF$x[KG_CONF$Column.A == 119])
state_data[120] <- (state_data[120]) * (KG_CONF$x[KG_CONF$Column.A == 120])
state_data[121] <- (state_data[121]) * (KG_CONF$x[KG_CONF$Column.A == 121])
state_data[122] <- (state_data[122]) * (KG_CONF$x[KG_CONF$Column.A == 122])
state_data[123] <- (state_data[123]) * (KG_CONF$x[KG_CONF$Column.A == 123])
state_data[124] <- (state_data[124]) * (KG_CONF$x[KG_CONF$Column.A == 124])
state_data[125] <- (state_data[125]) * (KG_CONF$x[KG_CONF$Column.A == 125])
state_data[126] <- (state_data[126]) * (KG_CONF$x[KG_CONF$Column.A == 126])
state_data[127] <- (state_data[127]) * (KG_CONF$x[KG_CONF$Column.A == 127])
state_data[128] <- (state_data[128]) * (KG_CONF$x[KG_CONF$Column.A == 128])
state_data[129] <- (state_data[129]) * (KG_CONF$x[KG_CONF$Column.A == 129])
state_data[130] <- (state_data[130]) * (KG_CONF$x[KG_CONF$Column.A == 130])
state_data[131] <- (state_data[131]) * (KG_CONF$x[KG_CONF$Column.A == 131])
state_data[132] <- (state_data[132]) * (KG_CONF$x[KG_CONF$Column.A == 132])
state_data[133] <- (state_data[133]) * (KG_CONF$x[KG_CONF$Column.A == 133])
state_data[134] <- (state_data[134]) * (KG_CONF$x[KG_CONF$Column.A == 134])
state_data[135] <- (state_data[135]) * (KG_CONF$x[KG_CONF$Column.A == 135])
state_data[136] <- (state_data[136]) * (KG_CONF$x[KG_CONF$Column.A == 136])
state_data[137] <- (state_data[137]) * (KG_CONF$x[KG_CONF$Column.A == 137])
state_data[138] <- (state_data[138]) * (KG_CONF$x[KG_CONF$Column.A == 138])
state_data[139] <- (state_data[139]) * (KG_CONF$x[KG_CONF$Column.A == 139])
state_data[130] <- (state_data[130]) * (KG_CONF$x[KG_CONF$Column.A == 140])
state_data[141] <- (state_data[141]) * (KG_CONF$x[KG_CONF$Column.A == 141])
state_data[142] <- (state_data[142]) * (KG_CONF$x[KG_CONF$Column.A == 142])
state_data[143] <- (state_data[143]) * (KG_CONF$x[KG_CONF$Column.A == 143])
state_data[144] <- (state_data[144]) * (KG_CONF$x[KG_CONF$Column.A == 144])
state_data[145] <- (state_data[145]) * (KG_CONF$x[KG_CONF$Column.A == 145])
state_data[146] <- (state_data[146]) * (KG_CONF$x[KG_CONF$Column.A == 146])
state_data[147] <- (state_data[147]) * (KG_CONF$x[KG_CONF$Column.A == 147])
state_data[148] <- (state_data[148]) * (KG_CONF$x[KG_CONF$Column.A == 148])
state_data[149] <- (state_data[149]) * (KG_CONF$x[KG_CONF$Column.A == 149])
state_data[150] <- (state_data[150]) * (KG_CONF$x[KG_CONF$Column.A == 150])
state_data[151] <- (state_data[151]) * (KG_CONF$x[KG_CONF$Column.A == 151])
state_data[152] <- (state_data[152]) * (KG_CONF$x[KG_CONF$Column.A == 152])
state_data[153] <- (state_data[153]) * (KG_CONF$x[KG_CONF$Column.A == 153])
state_data[154] <- (state_data[154]) * (KG_CONF$x[KG_CONF$Column.A == 154])
state_data[155] <- (state_data[155]) * (KG_CONF$x[KG_CONF$Column.A == 155])
state_data[156] <- (state_data[156]) * (KG_CONF$x[KG_CONF$Column.A == 156])
state_data[157] <- (state_data[157]) * (KG_CONF$x[KG_CONF$Column.A == 157])
state_data[158] <- (state_data[158]) * (KG_CONF$x[KG_CONF$Column.A == 158])
state_data[159] <- (state_data[159]) * (KG_CONF$x[KG_CONF$Column.A == 159])
state_data[160] <- (state_data[160]) * (KG_CONF$x[KG_CONF$Column.A == 160])
state_data[161] <- (state_data[161]) * (KG_CONF$x[KG_CONF$Column.A == 161])
state_data[162] <- (state_data[162]) * (KG_CONF$x[KG_CONF$Column.A == 162])
state_data[163] <- (state_data[163]) * (KG_CONF$x[KG_CONF$Column.A == 163])
state_data[164] <- (state_data[164]) * (KG_CONF$x[KG_CONF$Column.A == 164])
state_data[165] <- (state_data[165]) * (KG_CONF$x[KG_CONF$Column.A == 165])
state_data[166] <- (state_data[166]) * (KG_CONF$x[KG_CONF$Column.A == 166])
state_data[167] <- (state_data[167]) * (KG_CONF$x[KG_CONF$Column.A == 167])
state_data[168] <- (state_data[168]) * (KG_CONF$x[KG_CONF$Column.A == 168])
state_data[169] <- (state_data[169]) * (KG_CONF$x[KG_CONF$Column.A == 169])
state_data[170] <- (state_data[170]) * (KG_CONF$x[KG_CONF$Column.A == 170])
state_data[171] <- (state_data[171]) * (KG_CONF$x[KG_CONF$Column.A == 171])
state_data[172] <- (state_data[172]) * (KG_CONF$x[KG_CONF$Column.A == 172])
state_data[173] <- (state_data[173]) * (KG_CONF$x[KG_CONF$Column.A == 173])
state_data[174] <- (state_data[174]) * (KG_CONF$x[KG_CONF$Column.A == 174])
state_data[175] <- (state_data[175]) * (KG_CONF$x[KG_CONF$Column.A == 175])
state_data[176] <- (state_data[176]) * (KG_CONF$x[KG_CONF$Column.A == 176])
state_data[177] <- (state_data[177]) * (KG_CONF$x[KG_CONF$Column.A == 177])
state_data[178] <- (state_data[178]) * (KG_CONF$x[KG_CONF$Column.A == 178])
state_data[179] <- (state_data[179]) * (KG_CONF$x[KG_CONF$Column.A == 179])
state_data[180] <- (state_data[180]) * (KG_CONF$x[KG_CONF$Column.A == 180])
state_data[181] <- (state_data[181]) * (KG_CONF$x[KG_CONF$Column.A == 181])
state_data[182] <- (state_data[182]) * (KG_CONF$x[KG_CONF$Column.A == 182])
state_data[183] <- (state_data[183]) * (KG_CONF$x[KG_CONF$Column.A == 183])
state_data[184] <- (state_data[184]) * (KG_CONF$x[KG_CONF$Column.A == 184])
state_data[185] <- (state_data[185]) * (KG_CONF$x[KG_CONF$Column.A == 185])
state_data[186] <- (state_data[186]) * (KG_CONF$x[KG_CONF$Column.A == 186])
state_data[187] <- (state_data[187]) * (KG_CONF$x[KG_CONF$Column.A == 187])
state_data[188] <- (state_data[188]) * (KG_CONF$x[KG_CONF$Column.A == 188])
state_data[189] <- (state_data[189]) * (KG_CONF$x[KG_CONF$Column.A == 189])
state_data[190] <- (state_data[190]) * (KG_CONF$x[KG_CONF$Column.A == 190])
state_data[191] <- (state_data[191]) * (KG_CONF$x[KG_CONF$Column.A == 191])
state_data[192] <- (state_data[192]) * (KG_CONF$x[KG_CONF$Column.A == 192])
state_data[193] <- (state_data[193]) * (KG_CONF$x[KG_CONF$Column.A == 193])
state_data[194] <- (state_data[194]) * (KG_CONF$x[KG_CONF$Column.A == 194])
state_data[195] <- (state_data[195]) * (KG_CONF$x[KG_CONF$Column.A == 195])
state_data[196] <- (state_data[196]) * (KG_CONF$x[KG_CONF$Column.A == 196])
state_data[197] <- (state_data[197]) * (KG_CONF$x[KG_CONF$Column.A == 197])
state_data[198] <- (state_data[198]) * (KG_CONF$x[KG_CONF$Column.A == 198])
state_data[199] <- (state_data[199]) * (KG_CONF$x[KG_CONF$Column.A == 199])
state_data[200] <- (state_data[200]) * (KG_CONF$x[KG_CONF$Column.A == 200])
state_data[201] <- (state_data[201]) * (KG_CONF$x[KG_CONF$Column.A == 201])
state_data[202] <- (state_data[202]) * (KG_CONF$x[KG_CONF$Column.A == 202])
state_data[203] <- (state_data[203]) * (KG_CONF$x[KG_CONF$Column.A == 203])
state_data[204] <- (state_data[204]) * (KG_CONF$x[KG_CONF$Column.A == 204])
state_data[205] <- (state_data[205]) * (KG_CONF$x[KG_CONF$Column.A == 205])
state_data[206] <- (state_data[206]) * (KG_CONF$x[KG_CONF$Column.A == 206])
state_data[207] <- (state_data[207]) * (KG_CONF$x[KG_CONF$Column.A == 207])
state_data[208] <- (state_data[208]) * (KG_CONF$x[KG_CONF$Column.A == 208])
state_data[209] <- (state_data[209]) * (KG_CONF$x[KG_CONF$Column.A == 209])
state_data[210] <- (state_data[210]) * (KG_CONF$x[KG_CONF$Column.A == 210])
state_data[211] <- (state_data[211]) * (KG_CONF$x[KG_CONF$Column.A == 211])
state_data[212] <- (state_data[212]) * (KG_CONF$x[KG_CONF$Column.A == 212])
state_data[213] <- (state_data[213]) * (KG_CONF$x[KG_CONF$Column.A == 213])
state_data[214] <- (state_data[214]) * (KG_CONF$x[KG_CONF$Column.A == 214])
state_data[215] <- (state_data[215]) * (KG_CONF$x[KG_CONF$Column.A == 215])
state_data[216] <- (state_data[216]) * (KG_CONF$x[KG_CONF$Column.A == 216])
state_data[217] <- (state_data[217]) * (KG_CONF$x[KG_CONF$Column.A == 217])
state_data[218] <- (state_data[218]) * (KG_CONF$x[KG_CONF$Column.A == 218])
state_data[219] <- (state_data[219]) * (KG_CONF$x[KG_CONF$Column.A == 219])
state_data[220] <- (state_data[220]) * (KG_CONF$x[KG_CONF$Column.A == 220])
state_data[221] <- (state_data[221]) * (KG_CONF$x[KG_CONF$Column.A == 221])
state_data[222] <- (state_data[222]) * (KG_CONF$x[KG_CONF$Column.A == 222])
state_data[223] <- (state_data[223]) * (KG_CONF$x[KG_CONF$Column.A == 223])
state_data[224] <- (state_data[224]) * (KG_CONF$x[KG_CONF$Column.A == 224])
state_data[225] <- (state_data[225]) * (KG_CONF$x[KG_CONF$Column.A == 225])
state_data[226] <- (state_data[226]) * (KG_CONF$x[KG_CONF$Column.A == 226])
state_data[227] <- (state_data[227]) * (KG_CONF$x[KG_CONF$Column.A == 227])
state_data[228] <- (state_data[228]) * (KG_CONF$x[KG_CONF$Column.A == 228])
state_data[229] <- (state_data[229]) * (KG_CONF$x[KG_CONF$Column.A == 229])
state_data[230] <- (state_data[230]) * (KG_CONF$x[KG_CONF$Column.A == 230])
state_data[231] <- (state_data[231]) * (KG_CONF$x[KG_CONF$Column.A == 231])
state_data[232] <- (state_data[232]) * (KG_CONF$x[KG_CONF$Column.A == 232])
state_data[233] <- (state_data[233]) * (KG_CONF$x[KG_CONF$Column.A == 233])
state_data[234] <- (state_data[234]) * (KG_CONF$x[KG_CONF$Column.A == 234])
state_data[235] <- (state_data[235]) * (KG_CONF$x[KG_CONF$Column.A == 235])
state_data[236] <- (state_data[236]) * (KG_CONF$x[KG_CONF$Column.A == 236])
state_data[237] <- (state_data[237]) * (KG_CONF$x[KG_CONF$Column.A == 237])
state_data[238] <- (state_data[238]) * (KG_CONF$x[KG_CONF$Column.A == 238])
state_data[239] <- (state_data[239]) * (KG_CONF$x[KG_CONF$Column.A == 239])
state_data[230] <- (state_data[230]) * (KG_CONF$x[KG_CONF$Column.A == 240])
state_data[241] <- (state_data[241]) * (KG_CONF$x[KG_CONF$Column.A == 241])
state_data[242] <- (state_data[242]) * (KG_CONF$x[KG_CONF$Column.A == 242])
state_data[243] <- (state_data[243]) * (KG_CONF$x[KG_CONF$Column.A == 243])
state_data[244] <- (state_data[244]) * (KG_CONF$x[KG_CONF$Column.A == 244])
state_data[245] <- (state_data[245]) * (KG_CONF$x[KG_CONF$Column.A == 245])
state_data[246] <- (state_data[246]) * (KG_CONF$x[KG_CONF$Column.A == 246])
state_data[247] <- (state_data[247]) * (KG_CONF$x[KG_CONF$Column.A == 247])
state_data[248] <- (state_data[248]) * (KG_CONF$x[KG_CONF$Column.A == 248])
state_data[249] <- (state_data[249]) * (KG_CONF$x[KG_CONF$Column.A == 249])
state_data[250] <- (state_data[250]) * (KG_CONF$x[KG_CONF$Column.A == 250])
state_data[251] <- (state_data[251]) * (KG_CONF$x[KG_CONF$Column.A == 251])
state_data[252] <- (state_data[252]) * (KG_CONF$x[KG_CONF$Column.A == 252])
state_data[253] <- (state_data[253]) * (KG_CONF$x[KG_CONF$Column.A == 253])
state_data[254] <- (state_data[254]) * (KG_CONF$x[KG_CONF$Column.A == 254])
state_data[255] <- (state_data[255]) * (KG_CONF$x[KG_CONF$Column.A == 255])
state_data[256] <- (state_data[256]) * (KG_CONF$x[KG_CONF$Column.A == 256])
state_data[257] <- (state_data[257]) * (KG_CONF$x[KG_CONF$Column.A == 257])
state_data[258] <- (state_data[258]) * (KG_CONF$x[KG_CONF$Column.A == 258])
state_data[259] <- (state_data[259]) * (KG_CONF$x[KG_CONF$Column.A == 259])
state_data[260] <- (state_data[260]) * (KG_CONF$x[KG_CONF$Column.A == 260])
state_data[261] <- (state_data[261]) * (KG_CONF$x[KG_CONF$Column.A == 261])
state_data[262] <- (state_data[262]) * (KG_CONF$x[KG_CONF$Column.A == 262])
state_data[263] <- (state_data[263]) * (KG_CONF$x[KG_CONF$Column.A == 263])
state_data[264] <- (state_data[264]) * (KG_CONF$x[KG_CONF$Column.A == 264])
state_data[265] <- (state_data[265]) * (KG_CONF$x[KG_CONF$Column.A == 265])
state_data[266] <- (state_data[266]) * (KG_CONF$x[KG_CONF$Column.A == 266])
state_data[267] <- (state_data[267]) * (KG_CONF$x[KG_CONF$Column.A == 267])
state_data[268] <- (state_data[268]) * (KG_CONF$x[KG_CONF$Column.A == 268])
state_data[269] <- (state_data[269]) * (KG_CONF$x[KG_CONF$Column.A == 269])
state_data[270] <- (state_data[270]) * (KG_CONF$x[KG_CONF$Column.A == 270])
state_data[271] <- (state_data[271]) * (KG_CONF$x[KG_CONF$Column.A == 271])
state_data[272] <- (state_data[272]) * (KG_CONF$x[KG_CONF$Column.A == 272])
state_data[273] <- (state_data[273]) * (KG_CONF$x[KG_CONF$Column.A == 273])
state_data[274] <- (state_data[274]) * (KG_CONF$x[KG_CONF$Column.A == 274])
state_data[275] <- (state_data[275]) * (KG_CONF$x[KG_CONF$Column.A == 275])
state_data[276] <- (state_data[276]) * (KG_CONF$x[KG_CONF$Column.A == 276])
state_data[277] <- (state_data[277]) * (KG_CONF$x[KG_CONF$Column.A == 277])
state_data[278] <- (state_data[278]) * (KG_CONF$x[KG_CONF$Column.A == 278])
state_data[279] <- (state_data[279]) * (KG_CONF$x[KG_CONF$Column.A == 279])


state_data[1] <- (state_data[1]) * (KG_WCC$x[KG_WCC$Column.A == 1])
state_data[2] <- (state_data[2]) * (KG_WCC$x[KG_WCC$Column.A == 2])
state_data[3] <- (state_data[3]) * (KG_WCC$x[KG_WCC$Column.A == 3])
state_data[4] <- (state_data[4]) * (KG_WCC$x[KG_WCC$Column.A == 4])
state_data[5] <- (state_data[5]) * (KG_WCC$x[KG_WCC$Column.A == 5])
state_data[6] <- (state_data[6]) * (KG_WCC$x[KG_WCC$Column.A == 6])
state_data[7] <- (state_data[7]) * (KG_WCC$x[KG_WCC$Column.A == 7])
state_data[8] <- (state_data[8]) * (KG_WCC$x[KG_WCC$Column.A == 8])
state_data[9] <- (state_data[9]) * (KG_WCC$x[KG_WCC$Column.A == 9])
state_data[10] <- (state_data[10]) * (KG_WCC$x[KG_WCC$Column.A == 10])
state_data[11] <- (state_data[11]) * (KG_WCC$x[KG_WCC$Column.A == 11])
state_data[12] <- (state_data[12]) * (KG_WCC$x[KG_WCC$Column.A == 12])
state_data[13] <- (state_data[13]) * (KG_WCC$x[KG_WCC$Column.A == 13])
state_data[14] <- (state_data[14]) * (KG_WCC$x[KG_WCC$Column.A == 14])
state_data[15] <- (state_data[15]) * (KG_WCC$x[KG_WCC$Column.A == 15])
state_data[16] <- (state_data[16]) * (KG_WCC$x[KG_WCC$Column.A == 16])
state_data[17] <- (state_data[17]) * (KG_WCC$x[KG_WCC$Column.A == 17])
state_data[18] <- (state_data[18]) * (KG_WCC$x[KG_WCC$Column.A == 18])
state_data[19] <- (state_data[19]) * (KG_WCC$x[KG_WCC$Column.A == 19])
state_data[20] <- (state_data[20]) * (KG_WCC$x[KG_WCC$Column.A == 20])
state_data[21] <- (state_data[21]) * (KG_WCC$x[KG_WCC$Column.A == 21])
state_data[22] <- (state_data[22]) * (KG_WCC$x[KG_WCC$Column.A == 22])
state_data[23] <- (state_data[23]) * (KG_WCC$x[KG_WCC$Column.A == 23])
state_data[24] <- (state_data[24]) * (KG_WCC$x[KG_WCC$Column.A == 24])
state_data[25] <- (state_data[25]) * (KG_WCC$x[KG_WCC$Column.A == 25])
state_data[26] <- (state_data[26]) * (KG_WCC$x[KG_WCC$Column.A == 26])
state_data[27] <- (state_data[27]) * (KG_WCC$x[KG_WCC$Column.A == 27])
state_data[28] <- (state_data[28]) * (KG_WCC$x[KG_WCC$Column.A == 28])
state_data[29] <- (state_data[29]) * (KG_WCC$x[KG_WCC$Column.A == 29])
state_data[30] <- (state_data[30]) * (KG_WCC$x[KG_WCC$Column.A == 30])
state_data[31] <- (state_data[31]) * (KG_WCC$x[KG_WCC$Column.A == 31])
state_data[32] <- (state_data[32]) * (KG_WCC$x[KG_WCC$Column.A == 32])
state_data[33] <- (state_data[33]) * (KG_WCC$x[KG_WCC$Column.A == 33])
state_data[34] <- (state_data[34]) * (KG_WCC$x[KG_WCC$Column.A == 34])
state_data[35] <- (state_data[35]) * (KG_WCC$x[KG_WCC$Column.A == 35])
state_data[36] <- (state_data[36]) * (KG_WCC$x[KG_WCC$Column.A == 36])
state_data[37] <- (state_data[37]) * (KG_WCC$x[KG_WCC$Column.A == 37])
state_data[38] <- (state_data[38]) * (KG_WCC$x[KG_WCC$Column.A == 38])
state_data[39] <- (state_data[39]) * (KG_WCC$x[KG_WCC$Column.A == 39])
state_data[30] <- (state_data[30]) * (KG_WCC$x[KG_WCC$Column.A == 40])
state_data[41] <- (state_data[41]) * (KG_WCC$x[KG_WCC$Column.A == 41])
state_data[42] <- (state_data[42]) * (KG_WCC$x[KG_WCC$Column.A == 42])
state_data[43] <- (state_data[43]) * (KG_WCC$x[KG_WCC$Column.A == 43])
state_data[44] <- (state_data[44]) * (KG_WCC$x[KG_WCC$Column.A == 44])
state_data[45] <- (state_data[45]) * (KG_WCC$x[KG_WCC$Column.A == 45])
state_data[46] <- (state_data[46]) * (KG_WCC$x[KG_WCC$Column.A == 46])
state_data[47] <- (state_data[47]) * (KG_WCC$x[KG_WCC$Column.A == 47])
state_data[48] <- (state_data[48]) * (KG_WCC$x[KG_WCC$Column.A == 48])
state_data[49] <- (state_data[49]) * (KG_WCC$x[KG_WCC$Column.A == 49])
state_data[50] <- (state_data[50]) * (KG_WCC$x[KG_WCC$Column.A == 50])
state_data[51] <- (state_data[51]) * (KG_WCC$x[KG_WCC$Column.A == 51])
state_data[52] <- (state_data[52]) * (KG_WCC$x[KG_WCC$Column.A == 52])
state_data[53] <- (state_data[53]) * (KG_WCC$x[KG_WCC$Column.A == 53])
state_data[54] <- (state_data[54]) * (KG_WCC$x[KG_WCC$Column.A == 54])
state_data[55] <- (state_data[55]) * (KG_WCC$x[KG_WCC$Column.A == 55])
state_data[56] <- (state_data[56]) * (KG_WCC$x[KG_WCC$Column.A == 56])
state_data[57] <- (state_data[57]) * (KG_WCC$x[KG_WCC$Column.A == 57])
state_data[58] <- (state_data[58]) * (KG_WCC$x[KG_WCC$Column.A == 58])
state_data[59] <- (state_data[59]) * (KG_WCC$x[KG_WCC$Column.A == 59])
state_data[60] <- (state_data[60]) * (KG_WCC$x[KG_WCC$Column.A == 60])
state_data[61] <- (state_data[61]) * (KG_WCC$x[KG_WCC$Column.A == 61])
state_data[62] <- (state_data[62]) * (KG_WCC$x[KG_WCC$Column.A == 62])
state_data[63] <- (state_data[63]) * (KG_WCC$x[KG_WCC$Column.A == 63])
state_data[64] <- (state_data[64]) * (KG_WCC$x[KG_WCC$Column.A == 64])
state_data[65] <- (state_data[65]) * (KG_WCC$x[KG_WCC$Column.A == 65])
state_data[66] <- (state_data[66]) * (KG_WCC$x[KG_WCC$Column.A == 66])
state_data[67] <- (state_data[67]) * (KG_WCC$x[KG_WCC$Column.A == 67])
state_data[68] <- (state_data[68]) * (KG_WCC$x[KG_WCC$Column.A == 68])
state_data[69] <- (state_data[69]) * (KG_WCC$x[KG_WCC$Column.A == 69])
state_data[70] <- (state_data[70]) * (KG_WCC$x[KG_WCC$Column.A == 70])
state_data[71] <- (state_data[71]) * (KG_WCC$x[KG_WCC$Column.A == 71])
state_data[72] <- (state_data[72]) * (KG_WCC$x[KG_WCC$Column.A == 72])
state_data[73] <- (state_data[73]) * (KG_WCC$x[KG_WCC$Column.A == 73])
state_data[74] <- (state_data[74]) * (KG_WCC$x[KG_WCC$Column.A == 74])
state_data[75] <- (state_data[75]) * (KG_WCC$x[KG_WCC$Column.A == 75])
state_data[76] <- (state_data[76]) * (KG_WCC$x[KG_WCC$Column.A == 76])
state_data[77] <- (state_data[77]) * (KG_WCC$x[KG_WCC$Column.A == 77])
state_data[78] <- (state_data[78]) * (KG_WCC$x[KG_WCC$Column.A == 78])
state_data[79] <- (state_data[79]) * (KG_WCC$x[KG_WCC$Column.A == 79])
state_data[80] <- (state_data[80]) * (KG_WCC$x[KG_WCC$Column.A == 80])
state_data[81] <- (state_data[81]) * (KG_WCC$x[KG_WCC$Column.A == 81])
state_data[82] <- (state_data[82]) * (KG_WCC$x[KG_WCC$Column.A == 82])
state_data[83] <- (state_data[83]) * (KG_WCC$x[KG_WCC$Column.A == 83])
state_data[84] <- (state_data[84]) * (KG_WCC$x[KG_WCC$Column.A == 84])
state_data[85] <- (state_data[85]) * (KG_WCC$x[KG_WCC$Column.A == 85])
state_data[86] <- (state_data[86]) * (KG_WCC$x[KG_WCC$Column.A == 86])
state_data[87] <- (state_data[87]) * (KG_WCC$x[KG_WCC$Column.A == 87])
state_data[88] <- (state_data[88]) * (KG_WCC$x[KG_WCC$Column.A == 88])
state_data[89] <- (state_data[89]) * (KG_WCC$x[KG_WCC$Column.A == 89])
state_data[90] <- (state_data[90]) * (KG_WCC$x[KG_WCC$Column.A == 90])
state_data[91] <- (state_data[91]) * (KG_WCC$x[KG_WCC$Column.A == 91])
state_data[92] <- (state_data[92]) * (KG_WCC$x[KG_WCC$Column.A == 92])
state_data[93] <- (state_data[93]) * (KG_WCC$x[KG_WCC$Column.A == 93])
state_data[94] <- (state_data[94]) * (KG_WCC$x[KG_WCC$Column.A == 94])
state_data[95] <- (state_data[95]) * (KG_WCC$x[KG_WCC$Column.A == 95])
state_data[96] <- (state_data[96]) * (KG_WCC$x[KG_WCC$Column.A == 96])
state_data[97] <- (state_data[97]) * (KG_WCC$x[KG_WCC$Column.A == 97])
state_data[98] <- (state_data[98]) * (KG_WCC$x[KG_WCC$Column.A == 98])
state_data[99] <- (state_data[99]) * (KG_WCC$x[KG_WCC$Column.A == 99])
state_data[100] <- (state_data[100]) * (KG_WCC$x[KG_WCC$Column.A == 100])
state_data[101] <- (state_data[101]) * (KG_WCC$x[KG_WCC$Column.A == 101])
state_data[102] <- (state_data[102]) * (KG_WCC$x[KG_WCC$Column.A == 102])
state_data[103] <- (state_data[103]) * (KG_WCC$x[KG_WCC$Column.A == 103])
state_data[104] <- (state_data[104]) * (KG_WCC$x[KG_WCC$Column.A == 104])
state_data[105] <- (state_data[105]) * (KG_WCC$x[KG_WCC$Column.A == 105])
state_data[106] <- (state_data[106]) * (KG_WCC$x[KG_WCC$Column.A == 106])
state_data[107] <- (state_data[107]) * (KG_WCC$x[KG_WCC$Column.A == 107])
state_data[108] <- (state_data[108]) * (KG_WCC$x[KG_WCC$Column.A == 108])
state_data[109] <- (state_data[109]) * (KG_WCC$x[KG_WCC$Column.A == 109])
state_data[110] <- (state_data[110]) * (KG_WCC$x[KG_WCC$Column.A == 110])
state_data[111] <- (state_data[111]) * (KG_WCC$x[KG_WCC$Column.A == 111])
state_data[112] <- (state_data[112]) * (KG_WCC$x[KG_WCC$Column.A == 112])
state_data[113] <- (state_data[113]) * (KG_WCC$x[KG_WCC$Column.A == 113])
state_data[114] <- (state_data[114]) * (KG_WCC$x[KG_WCC$Column.A == 114])
state_data[115] <- (state_data[115]) * (KG_WCC$x[KG_WCC$Column.A == 115])
state_data[116] <- (state_data[116]) * (KG_WCC$x[KG_WCC$Column.A == 116])
state_data[117] <- (state_data[117]) * (KG_WCC$x[KG_WCC$Column.A == 117])
state_data[118] <- (state_data[118]) * (KG_WCC$x[KG_WCC$Column.A == 118])
state_data[119] <- (state_data[119]) * (KG_WCC$x[KG_WCC$Column.A == 119])
state_data[120] <- (state_data[120]) * (KG_WCC$x[KG_WCC$Column.A == 120])
state_data[121] <- (state_data[121]) * (KG_WCC$x[KG_WCC$Column.A == 121])
state_data[122] <- (state_data[122]) * (KG_WCC$x[KG_WCC$Column.A == 122])
state_data[123] <- (state_data[123]) * (KG_WCC$x[KG_WCC$Column.A == 123])
state_data[124] <- (state_data[124]) * (KG_WCC$x[KG_WCC$Column.A == 124])
state_data[125] <- (state_data[125]) * (KG_WCC$x[KG_WCC$Column.A == 125])
state_data[126] <- (state_data[126]) * (KG_WCC$x[KG_WCC$Column.A == 126])
state_data[127] <- (state_data[127]) * (KG_WCC$x[KG_WCC$Column.A == 127])
state_data[128] <- (state_data[128]) * (KG_WCC$x[KG_WCC$Column.A == 128])
state_data[129] <- (state_data[129]) * (KG_WCC$x[KG_WCC$Column.A == 129])
state_data[130] <- (state_data[130]) * (KG_WCC$x[KG_WCC$Column.A == 130])
state_data[131] <- (state_data[131]) * (KG_WCC$x[KG_WCC$Column.A == 131])
state_data[132] <- (state_data[132]) * (KG_WCC$x[KG_WCC$Column.A == 132])
state_data[133] <- (state_data[133]) * (KG_WCC$x[KG_WCC$Column.A == 133])
state_data[134] <- (state_data[134]) * (KG_WCC$x[KG_WCC$Column.A == 134])
state_data[135] <- (state_data[135]) * (KG_WCC$x[KG_WCC$Column.A == 135])
state_data[136] <- (state_data[136]) * (KG_WCC$x[KG_WCC$Column.A == 136])
state_data[137] <- (state_data[137]) * (KG_WCC$x[KG_WCC$Column.A == 137])
state_data[138] <- (state_data[138]) * (KG_WCC$x[KG_WCC$Column.A == 138])
state_data[139] <- (state_data[139]) * (KG_WCC$x[KG_WCC$Column.A == 139])
state_data[130] <- (state_data[130]) * (KG_WCC$x[KG_WCC$Column.A == 140])
state_data[141] <- (state_data[141]) * (KG_WCC$x[KG_WCC$Column.A == 141])
state_data[142] <- (state_data[142]) * (KG_WCC$x[KG_WCC$Column.A == 142])
state_data[143] <- (state_data[143]) * (KG_WCC$x[KG_WCC$Column.A == 143])
state_data[144] <- (state_data[144]) * (KG_WCC$x[KG_WCC$Column.A == 144])
state_data[145] <- (state_data[145]) * (KG_WCC$x[KG_WCC$Column.A == 145])
state_data[146] <- (state_data[146]) * (KG_WCC$x[KG_WCC$Column.A == 146])
state_data[147] <- (state_data[147]) * (KG_WCC$x[KG_WCC$Column.A == 147])
state_data[148] <- (state_data[148]) * (KG_WCC$x[KG_WCC$Column.A == 148])
state_data[149] <- (state_data[149]) * (KG_WCC$x[KG_WCC$Column.A == 149])
state_data[150] <- (state_data[150]) * (KG_WCC$x[KG_WCC$Column.A == 150])
state_data[151] <- (state_data[151]) * (KG_WCC$x[KG_WCC$Column.A == 151])
state_data[152] <- (state_data[152]) * (KG_WCC$x[KG_WCC$Column.A == 152])
state_data[153] <- (state_data[153]) * (KG_WCC$x[KG_WCC$Column.A == 153])
state_data[154] <- (state_data[154]) * (KG_WCC$x[KG_WCC$Column.A == 154])
state_data[155] <- (state_data[155]) * (KG_WCC$x[KG_WCC$Column.A == 155])
state_data[156] <- (state_data[156]) * (KG_WCC$x[KG_WCC$Column.A == 156])
state_data[157] <- (state_data[157]) * (KG_WCC$x[KG_WCC$Column.A == 157])
state_data[158] <- (state_data[158]) * (KG_WCC$x[KG_WCC$Column.A == 158])
state_data[159] <- (state_data[159]) * (KG_WCC$x[KG_WCC$Column.A == 159])
state_data[160] <- (state_data[160]) * (KG_WCC$x[KG_WCC$Column.A == 160])
state_data[161] <- (state_data[161]) * (KG_WCC$x[KG_WCC$Column.A == 161])
state_data[162] <- (state_data[162]) * (KG_WCC$x[KG_WCC$Column.A == 162])
state_data[163] <- (state_data[163]) * (KG_WCC$x[KG_WCC$Column.A == 163])
state_data[164] <- (state_data[164]) * (KG_WCC$x[KG_WCC$Column.A == 164])
state_data[165] <- (state_data[165]) * (KG_WCC$x[KG_WCC$Column.A == 165])
state_data[166] <- (state_data[166]) * (KG_WCC$x[KG_WCC$Column.A == 166])
state_data[167] <- (state_data[167]) * (KG_WCC$x[KG_WCC$Column.A == 167])
state_data[168] <- (state_data[168]) * (KG_WCC$x[KG_WCC$Column.A == 168])
state_data[169] <- (state_data[169]) * (KG_WCC$x[KG_WCC$Column.A == 169])
state_data[170] <- (state_data[170]) * (KG_WCC$x[KG_WCC$Column.A == 170])
state_data[171] <- (state_data[171]) * (KG_WCC$x[KG_WCC$Column.A == 171])
state_data[172] <- (state_data[172]) * (KG_WCC$x[KG_WCC$Column.A == 172])
state_data[173] <- (state_data[173]) * (KG_WCC$x[KG_WCC$Column.A == 173])
state_data[174] <- (state_data[174]) * (KG_WCC$x[KG_WCC$Column.A == 174])
state_data[175] <- (state_data[175]) * (KG_WCC$x[KG_WCC$Column.A == 175])
state_data[176] <- (state_data[176]) * (KG_WCC$x[KG_WCC$Column.A == 176])
state_data[177] <- (state_data[177]) * (KG_WCC$x[KG_WCC$Column.A == 177])
state_data[178] <- (state_data[178]) * (KG_WCC$x[KG_WCC$Column.A == 178])
state_data[179] <- (state_data[179]) * (KG_WCC$x[KG_WCC$Column.A == 179])
state_data[180] <- (state_data[180]) * (KG_WCC$x[KG_WCC$Column.A == 180])
state_data[181] <- (state_data[181]) * (KG_WCC$x[KG_WCC$Column.A == 181])
state_data[182] <- (state_data[182]) * (KG_WCC$x[KG_WCC$Column.A == 182])
state_data[183] <- (state_data[183]) * (KG_WCC$x[KG_WCC$Column.A == 183])
state_data[184] <- (state_data[184]) * (KG_WCC$x[KG_WCC$Column.A == 184])
state_data[185] <- (state_data[185]) * (KG_WCC$x[KG_WCC$Column.A == 185])
state_data[186] <- (state_data[186]) * (KG_WCC$x[KG_WCC$Column.A == 186])
state_data[187] <- (state_data[187]) * (KG_WCC$x[KG_WCC$Column.A == 187])
state_data[188] <- (state_data[188]) * (KG_WCC$x[KG_WCC$Column.A == 188])
state_data[189] <- (state_data[189]) * (KG_WCC$x[KG_WCC$Column.A == 189])
state_data[190] <- (state_data[190]) * (KG_WCC$x[KG_WCC$Column.A == 190])
state_data[191] <- (state_data[191]) * (KG_WCC$x[KG_WCC$Column.A == 191])
state_data[192] <- (state_data[192]) * (KG_WCC$x[KG_WCC$Column.A == 192])
state_data[193] <- (state_data[193]) * (KG_WCC$x[KG_WCC$Column.A == 193])
state_data[194] <- (state_data[194]) * (KG_WCC$x[KG_WCC$Column.A == 194])
state_data[195] <- (state_data[195]) * (KG_WCC$x[KG_WCC$Column.A == 195])
state_data[196] <- (state_data[196]) * (KG_WCC$x[KG_WCC$Column.A == 196])
state_data[197] <- (state_data[197]) * (KG_WCC$x[KG_WCC$Column.A == 197])
state_data[198] <- (state_data[198]) * (KG_WCC$x[KG_WCC$Column.A == 198])
state_data[199] <- (state_data[199]) * (KG_WCC$x[KG_WCC$Column.A == 199])
state_data[200] <- (state_data[200]) * (KG_WCC$x[KG_WCC$Column.A == 200])
state_data[201] <- (state_data[201]) * (KG_WCC$x[KG_WCC$Column.A == 201])
state_data[202] <- (state_data[202]) * (KG_WCC$x[KG_WCC$Column.A == 202])
state_data[203] <- (state_data[203]) * (KG_WCC$x[KG_WCC$Column.A == 203])
state_data[204] <- (state_data[204]) * (KG_WCC$x[KG_WCC$Column.A == 204])
state_data[205] <- (state_data[205]) * (KG_WCC$x[KG_WCC$Column.A == 205])
state_data[206] <- (state_data[206]) * (KG_WCC$x[KG_WCC$Column.A == 206])
state_data[207] <- (state_data[207]) * (KG_WCC$x[KG_WCC$Column.A == 207])
state_data[208] <- (state_data[208]) * (KG_WCC$x[KG_WCC$Column.A == 208])
state_data[209] <- (state_data[209]) * (KG_WCC$x[KG_WCC$Column.A == 209])
state_data[210] <- (state_data[210]) * (KG_WCC$x[KG_WCC$Column.A == 210])
state_data[211] <- (state_data[211]) * (KG_WCC$x[KG_WCC$Column.A == 211])
state_data[212] <- (state_data[212]) * (KG_WCC$x[KG_WCC$Column.A == 212])
state_data[213] <- (state_data[213]) * (KG_WCC$x[KG_WCC$Column.A == 213])
state_data[214] <- (state_data[214]) * (KG_WCC$x[KG_WCC$Column.A == 214])
state_data[215] <- (state_data[215]) * (KG_WCC$x[KG_WCC$Column.A == 215])
state_data[216] <- (state_data[216]) * (KG_WCC$x[KG_WCC$Column.A == 216])
state_data[217] <- (state_data[217]) * (KG_WCC$x[KG_WCC$Column.A == 217])
state_data[218] <- (state_data[218]) * (KG_WCC$x[KG_WCC$Column.A == 218])
state_data[219] <- (state_data[219]) * (KG_WCC$x[KG_WCC$Column.A == 219])
state_data[220] <- (state_data[220]) * (KG_WCC$x[KG_WCC$Column.A == 220])
state_data[221] <- (state_data[221]) * (KG_WCC$x[KG_WCC$Column.A == 221])
state_data[222] <- (state_data[222]) * (KG_WCC$x[KG_WCC$Column.A == 222])
state_data[223] <- (state_data[223]) * (KG_WCC$x[KG_WCC$Column.A == 223])
state_data[224] <- (state_data[224]) * (KG_WCC$x[KG_WCC$Column.A == 224])
state_data[225] <- (state_data[225]) * (KG_WCC$x[KG_WCC$Column.A == 225])
state_data[226] <- (state_data[226]) * (KG_WCC$x[KG_WCC$Column.A == 226])
state_data[227] <- (state_data[227]) * (KG_WCC$x[KG_WCC$Column.A == 227])
state_data[228] <- (state_data[228]) * (KG_WCC$x[KG_WCC$Column.A == 228])
state_data[229] <- (state_data[229]) * (KG_WCC$x[KG_WCC$Column.A == 229])
state_data[230] <- (state_data[230]) * (KG_WCC$x[KG_WCC$Column.A == 230])
state_data[231] <- (state_data[231]) * (KG_WCC$x[KG_WCC$Column.A == 231])
state_data[232] <- (state_data[232]) * (KG_WCC$x[KG_WCC$Column.A == 232])
state_data[233] <- (state_data[233]) * (KG_WCC$x[KG_WCC$Column.A == 233])
state_data[234] <- (state_data[234]) * (KG_WCC$x[KG_WCC$Column.A == 234])
state_data[235] <- (state_data[235]) * (KG_WCC$x[KG_WCC$Column.A == 235])
state_data[236] <- (state_data[236]) * (KG_WCC$x[KG_WCC$Column.A == 236])
state_data[237] <- (state_data[237]) * (KG_WCC$x[KG_WCC$Column.A == 237])
state_data[238] <- (state_data[238]) * (KG_WCC$x[KG_WCC$Column.A == 238])
state_data[239] <- (state_data[239]) * (KG_WCC$x[KG_WCC$Column.A == 239])
state_data[230] <- (state_data[230]) * (KG_WCC$x[KG_WCC$Column.A == 240])
state_data[241] <- (state_data[241]) * (KG_WCC$x[KG_WCC$Column.A == 241])
state_data[242] <- (state_data[242]) * (KG_WCC$x[KG_WCC$Column.A == 242])
state_data[243] <- (state_data[243]) * (KG_WCC$x[KG_WCC$Column.A == 243])
state_data[244] <- (state_data[244]) * (KG_WCC$x[KG_WCC$Column.A == 244])
state_data[245] <- (state_data[245]) * (KG_WCC$x[KG_WCC$Column.A == 245])
state_data[246] <- (state_data[246]) * (KG_WCC$x[KG_WCC$Column.A == 246])
state_data[247] <- (state_data[247]) * (KG_WCC$x[KG_WCC$Column.A == 247])
state_data[248] <- (state_data[248]) * (KG_WCC$x[KG_WCC$Column.A == 248])
state_data[249] <- (state_data[249]) * (KG_WCC$x[KG_WCC$Column.A == 249])
state_data[250] <- (state_data[250]) * (KG_WCC$x[KG_WCC$Column.A == 250])
state_data[251] <- (state_data[251]) * (KG_WCC$x[KG_WCC$Column.A == 251])
state_data[252] <- (state_data[252]) * (KG_WCC$x[KG_WCC$Column.A == 252])
state_data[253] <- (state_data[253]) * (KG_WCC$x[KG_WCC$Column.A == 253])
state_data[254] <- (state_data[254]) * (KG_WCC$x[KG_WCC$Column.A == 254])
state_data[255] <- (state_data[255]) * (KG_WCC$x[KG_WCC$Column.A == 255])
state_data[256] <- (state_data[256]) * (KG_WCC$x[KG_WCC$Column.A == 256])
state_data[257] <- (state_data[257]) * (KG_WCC$x[KG_WCC$Column.A == 257])
state_data[258] <- (state_data[258]) * (KG_WCC$x[KG_WCC$Column.A == 258])
state_data[259] <- (state_data[259]) * (KG_WCC$x[KG_WCC$Column.A == 259])
state_data[260] <- (state_data[260]) * (KG_WCC$x[KG_WCC$Column.A == 260])
state_data[261] <- (state_data[261]) * (KG_WCC$x[KG_WCC$Column.A == 261])
state_data[262] <- (state_data[262]) * (KG_WCC$x[KG_WCC$Column.A == 262])
state_data[263] <- (state_data[263]) * (KG_WCC$x[KG_WCC$Column.A == 263])
state_data[264] <- (state_data[264]) * (KG_WCC$x[KG_WCC$Column.A == 264])
state_data[265] <- (state_data[265]) * (KG_WCC$x[KG_WCC$Column.A == 265])
state_data[266] <- (state_data[266]) * (KG_WCC$x[KG_WCC$Column.A == 266])
state_data[267] <- (state_data[267]) * (KG_WCC$x[KG_WCC$Column.A == 267])
state_data[268] <- (state_data[268]) * (KG_WCC$x[KG_WCC$Column.A == 268])
state_data[269] <- (state_data[269]) * (KG_WCC$x[KG_WCC$Column.A == 269])
state_data[270] <- (state_data[270]) * (KG_WCC$x[KG_WCC$Column.A == 270])
state_data[271] <- (state_data[271]) * (KG_WCC$x[KG_WCC$Column.A == 271])
state_data[272] <- (state_data[272]) * (KG_WCC$x[KG_WCC$Column.A == 272])
state_data[273] <- (state_data[273]) * (KG_WCC$x[KG_WCC$Column.A == 273])
state_data[274] <- (state_data[274]) * (KG_WCC$x[KG_WCC$Column.A == 274])
state_data[275] <- (state_data[275]) * (KG_WCC$x[KG_WCC$Column.A == 275])
state_data[276] <- (state_data[276]) * (KG_WCC$x[KG_WCC$Column.A == 276])
state_data[277] <- (state_data[277]) * (KG_WCC$x[KG_WCC$Column.A == 277])
state_data[278] <- (state_data[278]) * (KG_WCC$x[KG_WCC$Column.A == 278])
state_data[279] <- (state_data[279]) * (KG_WCC$x[KG_WCC$Column.A == 279])
...
KG_CONF_na_omit <- na.omit(KG_CONF)
n <- 25
KG_FS25 <- KG_CONF_na_omit[KG_CONF_na_omit$x > quantile(KG_CONF_na_omit$x,prob=1-n/100),]
fs_list <- sort(as.numeric(KG_FS25$Column.A))
fs_list
...
#feature_selection <- state_data[ c(8,22,24,26,35,36,37,40,42,45,46,53,56,58,63,69,73,90,92,204,205,208,209,211,212,217,222,225,235,251,255,261,54,167) ] 
feature_selection <- state_data[ c(final_list) ] 
write.csv(na.omit(feature_selection), "LLCP2020XPT_Grounded_KGFS25_CONF.csv")




KG_WCC_na_omit <- na.omit(KG_WCC)
n <- 25
KG_FS25 <- KG_WCC_na_omit[KG_WCC_na_omit$x > quantile(KG_WCC_na_omit$x,prob=1-n/100),]
fs_list <- sort(as.numeric(KG_FS25$Column.A))
fs_list
...
#feature_selection <- state_data[ c(8,22,24,26,35,36,37,40,42,45,46,53,56,58,63,69,73,90,92,204,205,208,209,211,212,217,222,225,235,251,255,261,54,167) ] 
feature_selection <- state_data[ c(final_list) ] 
write.csv(na.omit(feature_selection), "LLCP2020XPT_Grounded_KGFS25_WCC.csv")